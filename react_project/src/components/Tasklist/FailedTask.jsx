...
function Failed({task}){
  ...
  return <>
   <div className="h-full w-[250px]  bg-yellow-400 rounded-xl shrink-0 p-2">
      ...
      <div className="flex justify-center w-full  text-white pt-3 mb-2">
       <button className=" bg-yellow-700 rounded-sm px-8 hover:bg-yellow-900">Task get failed</button>
      </div>
    </div>
  </>
}
